...
<script type="text/babel">
  ...
  import RepeatClick from '../../../core/directives/repeat-click';
  ...
  export default {
    ...
    methods: {
      ...
      handleScroll(type) {
        if (this.currentTimeout[type]) window.clearTimeout(this.currentTimeout[type]);
        let $this = this;
        this.currentTimeout[type] = setTimeout(function(){
