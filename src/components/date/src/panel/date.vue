<template>
  <transition name="el-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      ...
      <div class="el-picker-panel__footer" v-show="footerVisible && currentView === 'date'" v-clickoutside="() => timePickerVisible = false">
          <div class="el-date-picker__time-editor-wrap">
            <time-picker ref="timepicker" :time-arrow-control="arrowControl"
              @pick="handleTimePick" :visible="timePickerVisible"
              @mounted="proxyTimePickerDataProperties">
            </time-picker>
          </div>
          <input class="el-picker-panel__time-input" 
            ...
            ref="input"/>
          <a href="javascript:void(0);" class="el-picker-panel__link-btn text" @click="changeToNow">{{ t('el.datepicker.now') }}</a>
          <a href="javascript:void(0);" class="el-picker-panel__link-btn confirm" @click="confirm">{{ t('el.datepicker.confirm') }}</a>
      </div>
    </div>
  </transition>
</template>
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      updateTime(e){
        this.userInputTime = e.target.value;
      },
