        ...
        <div class="el-picker-panel__body">
          <div class="el-date-range-picker__time-header" v-if="showTime">
            <span class="el-date-range-picker__editors-wrap">
              <span class="el-date-range-picker__date-picker-wrap is-start-date">
                  {{minVisibleDate}}
              </span>
              <span class="el-date-range-picker__date-picker-wrap" v-clickoutside="() => minTimePickerVisible = false">
                <input class="el-picker-panel__time-input el-date-range-picker__editor"
                  :class="{ 'is-disabled': rangeState.selecting }"
            ...
            <span class="el-date-range-picker__editors-wrap is-right">
              <span class="el-date-range-picker__date-picker-wrap is-end-date">
                  {{maxVisibleDate}}
              </span>
              <span class="el-date-range-picker__date-picker-wrap" v-clickoutside="() => maxTimePickerVisible = false">
                  <input class="el-picker-panel__time-input el-date-range-picker__editor"
                    :class="{ 'is-disabled': rangeState.selecting }"
                    :disabled="rangeState.selecting"
                    ref="maxInput"
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      minVisibleDate() {
        return this.minDate ? formatDate(this.minDate, this.dateFormat) : formatDate(this.minDate=new Date(), this.dateFormat);
      },
